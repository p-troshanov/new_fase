...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NEW FACE — Natural Face Method" },
      { name: "description", content: "Авторский метод самомассажа лица и работы с осанкой NEW FACE. Курс, интенсив и бесплатный стартовый набор." },
      { property: "og:site_name", content: "NEW FACE" },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    return () => {
      mounted = false;
      const sub = (window as any).__auth_sub;
